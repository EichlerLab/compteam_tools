...
MERQURY_DIR = '/net/eichler/vol27/projects/autism_genome_assembly/nobackups/analysis/merqury/merqury'
ASSEMBLY_DIR = '/net/eichler/vol27/projects/autism_genome_assembly/nobackups/assemblies/hifiasm_0.16.1'
LRA_DIR = '/net/eichler/vol28/projects/long_read_archive/nobackups/clinical/'
...
def main():
    ...
    mq_df = get_merqury_stats_df(MERQURY_DIR, args.sample)
    n50_df = get_n50(ASSEMBLY_DIR, args.sample)
    cov_df = get_coverage_x(LRA_DIR, args.sample)
